...
title: edge
description: Terraform component `edge` managed in a tfscaffold repository.
tags:
- terraform
- tfscaffold
- component
...
This tfscaffold component summarizes the Terraform root under `components/edge` and highlights its interface, dependencies, and generated references.

Kind: **tfscaffold component**

Source directory: `components/edge`
