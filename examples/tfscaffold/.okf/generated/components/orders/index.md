...
title: orders
description: Terraform component `orders` managed in a tfscaffold repository.
tags:
- terraform
- tfscaffold
- component
...
This tfscaffold component summarizes the Terraform root under `components/orders` and highlights its interface, dependencies, and generated references.

Kind: **tfscaffold component**

Source directory: `components/orders`
