...
title: notifications
description: Terraform component `notifications` managed in a tfscaffold repository.
tags:
- terraform
- tfscaffold
- component
...
This tfscaffold component summarizes the Terraform root under `components/notifications` and highlights its interface, dependencies, and generated references.

Kind: **tfscaffold component**

Source directory: `components/notifications`
